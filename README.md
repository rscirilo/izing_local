...
Execute comando na pasta raiz do projeto (izing.pro)
...
A utilização desta ferramenta é feita por sua conta e risco. O código é da comunidade PRO, mas podem existir bugs e problemas de segurança.
